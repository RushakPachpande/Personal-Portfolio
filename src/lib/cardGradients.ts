...
export const cardGradients: Record<CardGradientKey, string> = {
  ...
  stat:
    'bg-[radial-gradient(ellipse_80%_60%_at_50%_30%,rgba(34,211,238,0.25),transparent_55%),radial-gradient(ellipse_60%_50%_at_20%_80%,rgba(59,130,246,0.2),transparent_50%),linear-gradient(145deg,rgba(17,24,39,0.95),rgba(11,18,36,0.98))]',
  experience:
