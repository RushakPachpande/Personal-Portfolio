...
export function getCaseStudiesByCategory(caseStudies: CaseStudy[], category: CaseStudyCategory) {
...
export function getRelatedCaseStudies(caseStudies: CaseStudy[], study: CaseStudy) {
