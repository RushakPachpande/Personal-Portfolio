...
const links = [
  ...
  { to: 'site/content', label: 'Site content', icon: Settings2 },
  { to: 'site/navigation', label: 'Navigation', icon: Navigation },
  { to: 'site/categories', label: 'Categories', icon: Briefcase },
  { to: 'site/brand', label: 'Brand', icon: Palette },
  { to: 'site/seo', label: 'SEO', icon: Search },
  { to: 'site/flags', label: 'Flags & docs', icon: ToggleLeft },
