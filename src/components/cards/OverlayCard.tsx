    ...
    >
      <div
        className={cn(
          ...
          featured ? 'aspect-[4/3] sm:aspect-[16/9]' : 'aspect-[4/3] sm:aspect-[16/10]',
      ...
      >
        ...
        {href ? (
          <span className="absolute top-3 right-3 inline-flex size-8 items-center justify-center rounded-full border border-border/80 bg-background/60 text-muted-foreground opacity-0 transition-opacity duration-300 group-hover/card:opacity-100 group-focus-within/card:opacity-100 sm:top-4 sm:right-4">
